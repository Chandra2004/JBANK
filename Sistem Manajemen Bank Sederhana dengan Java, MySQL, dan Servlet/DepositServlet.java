    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) 
        ...
        try {
            ...
            if (amount.compareTo(BigDecimal.ZERO) <= 0) {
                request.setAttribute("error", "Jumlah deposit harus lebih dari 0");
                request.getRequestDispatcher("deposit.jsp").forward(request, response);
                return;
            }
            ...
            try {
                ...
                // Insert transaction
                String transSql = "INSERT INTO transactions (account_id, transaction_type, amount, description) VALUES (?, 'DEPOSIT', ?, ?)";
                ...
                request.setAttribute("success", "Deposit berhasil! Saldo Anda sekarang: Rp " + account.getBalance());
                request.getRequestDispatcher("deposit.jsp").forward(request, response);
